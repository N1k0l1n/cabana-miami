...
interface LuxuryFormFieldProps extends React.InputHTMLAttributes<HTMLInputElement> {
  label: string
  error?: string
}

export function LuxuryFormField({ label, error, ...props }: LuxuryFormFieldProps) {
  return (
    <motion.div
      className="mb-4"
